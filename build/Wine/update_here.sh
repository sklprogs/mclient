...
cp -vu /usr/local/bin/mclient/src/{cells.py,db.py,elems.py,kl_mod_win.py,mclient.py,mclient.cfg,mkhtml.py,page.py,tags.py} .

# Wine-only
cp -vu /usr/local/bin/mclient/build/Wine/setup.py .
