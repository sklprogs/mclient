...
mkdir -p ./{resources/{buttons,locale/ru/LC_MESSAGES},src/tkhtml,user/dics}
...
# (Linux-only) Copy tkinterhtml (follows the symlink)
cp -r /usr/local/bin/tkhtml/* ./src/tkhtml/
