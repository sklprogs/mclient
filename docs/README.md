...
biggest dictionaries in the world; used by professional translators.
...
its license. Also used by professionals.

- StarDict&mdash;well-known dictionary format.

- Fora&mdash;dictionary app; tries to combine different formats under the hood.

Articles are drafted as tables. Article items can be accessed in an
