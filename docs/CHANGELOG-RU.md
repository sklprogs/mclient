...
## 7.0.2
* Адаптация изменений multitran.com (тезаурус, словоформы из нескольких слов)

## 7.0.1
* Адаптация изменений multitran.com (словоформы)
...
* Обеспечена поддержка тематик на нескольких языках на основе multitran.com
...
* Поддержка подсказок с multitran.com для слов с орфографическими ошибками
* Поддержка раздела `⇒`
...
## 6.7
* Улучшено разграничение ячеек для multitran.com (разграничение ячеек на основе
...
## 5.7.2
* Исправлены тэги для статьи *invoice*

## 5.7.1
* Задать максимальное время ожидания ответа от сервера (по умолчанию - 6
  секунд)
...
## 4.8.2
* Исправлены тэги при нахождении только отдельных слов

## 4.8.1
* Улучшение алгоритма извлечения тэгов

## 4.8
* Изменение ссылки пары ENG-RUS на альтернативную, не требующую регистрации
  при открытии в браузере
* Распознавание частей речи в паре DEU-RUS

## 4.7.8
* Исправление ссылок ввиду изменений на multitran.ru
...
* Добавлено направление RUS ⇔  XAL, поскольку иначе формируется неверный URL
  для слов на русском
