...
| `F1` | кнопка «О программе» | <img src="../resources/buttons/show_about.png" width="36" height="36" /> | сведения о программе | `actions → toggle_about` |
...
| `F2`, `Ctrl+S` | кнопка «Сохранить» | <img src="../resources/buttons/save_article.png" width="36" height="36" /> | сохранить или скопировать текущую статью | `actions → save_article` |
...
| `Ctrl+D` | кнопка «Значение» | <img src="../resources/buttons/define.png" width="36" height="36" /> | открыть веб-страницу с определением текущего термина | `actions → define` |
...
| `Return`, `Enter` | нажать ЛКМ | <img src="../resources/buttons/go_search.png" width="36" height="36" /> | вернуть перевод выделенной ячейки | |
...
| `Ctrl+V` | нажать ПКМ в строке поиска | <img src="../resources/buttons/paste.png" width="36" height="36" /> | |
