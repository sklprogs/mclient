...
class Elems:
    ...
    def __init__(self, blocks, Debug=False):
        f = '[MClient] plugins.fora.dsl.elems.Elems.__init__'
        self.cells = []
        self.art_subj = {}
    ...
    def set_cells(self):
        f = '[MClient] plugins.fora.dsl.elems.Elems.set_cells'
        if not self.blocks:
            rep.empty(f)
            return
    ...
    def unite_brackets(self):
        ...
        '''
        f = '[MClient] plugins.fora.dsl.elems.Elems.unite_brackets'
        count = 0
    ...
    def set_row_nos(self):
        ...
        f = '[MClient] plugins.fora.dsl.elems.Elems.set_row_nos'
        count = 0
        if self.cells:
            count += 1
    ...
    def delete_fixed(self):
        f = '[MClient] plugins.fora.dsl.elems.Elems.delete_fixed'
        count = 0
        i = 0
        while i < len(self.cells):
    ...
    def _debug_cells(self, maxrow=30, maxrows=0):
        f = '[MClient] plugins.fora.dsl.elems.Elems._debug_cells'
    ...
    def _debug_blocks(self, maxrow=70, maxrows=1000):
        f = '[MClient] plugins.fora.dsl.elems.Elems.debug'
