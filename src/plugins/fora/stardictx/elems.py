...
class Phrases:
    ...
    def replace_seps(self):
        f = '[MClient] plugins.fora.stardictx.elems.Phrases.replace_seps'
    ...
    def _split_block(self, block):
        f = '[MClient] plugins.fora.stardictx.elems.Phrases._split_block'
    ...
    def split(self):
        f = '[MClient] plugins.fora.stardictx.elems.Phrases.split'
        blocks = []
    ...
    def run(self):
        f = '[MClient] plugins.fora.stardictx.elems.Phrases.run'
        if not HEURISTICS:
            rep.lazy(f)
            return self.blocks
        self.replace_seps()
...
class Elems:
    ...
    def __init__(self, blocks):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.__init__'
        self.set_values()
        self.blocks = blocks
        if self.blocks:
            self.Success = True
    ...
    def set_cells(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.set_cells'
        if not self.blocks:
            rep.empty(f)
            return
    ...
    def unite_brackets(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.unite_brackets'
        if not HEURISTICS:
            rep.lazy(f)
            return
    ...
    def set_row_nos(self):
        ...
        f = '[MClient] plugins.fora.stardictx.elems.Elems.set_row_nos'
        count = 0
        if self.cells:
            count += 1
    ...
    def set_art_subj(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.set_art_subj'
        count = 0
        for block in self.blocks:
    ...
    def delete_fixed(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.delete_fixed'
        count = 0
        i = 0
        while i < len(self.cells):
            if self.cells[i].fixed_block:
    ...
    def set_synonyms(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.set_synonyms'
        if not HEURISTICS:
            rep.lazy(f)
            return
        i = 1
    ...
    def run(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.run'
        if not self.Success:
            rep.cancel(f)
            return []
    ...
    def unite_comments(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.unite_comments'
        if not HEURISTICS:
            rep.lazy(f)
            return
        i = 1
    ...
    def run_comments(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.run_comments'
        if not HEURISTICS:
            rep.lazy(f)
            return
        i = 0
    ...
    def set_com_same(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.set_com_same'
        if not HEURISTICS:
            rep.lazy(f)
            return
    ...
    def add_space(self):
        f = '[MClient] plugins.fora.stardictx.elems.Elems.add_space'
        if not HEURISTICS:
            rep.lazy(f)
            return
        i = 1
