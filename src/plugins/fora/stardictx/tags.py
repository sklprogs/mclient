...
class Tags:
    ...
    def debug_tags(self):
        f = '[MClient] plugins.fora.stardictx.tags.Tags.debug_tags'
        mes = []
    ...
    def debug_blocks (self):
        f = '[MClient] plugins.fora.stardictx.tags.Tags.debug_blocks'
    ...
    def unescape(self):
        ''' Convert HTM entities to a human-readable format, for example,
            '&copy;' -> '©'.
        '''
        f = '[MClient] plugins.fora.stardictx.tags.Tags.unescape'
