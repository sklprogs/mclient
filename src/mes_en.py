...
adding_search_results='Adding search results...'
...
amended_claims='Amended claims: "%s"'
amended_claims_mode_failure='The amended claims mode was set, however, they have not been found.'
...
articles_found='Articles found: %d.'
...
claims_table_date='The last table of the amended claims is probably missing. The table date has been determined as %s, the claims file date - %s.'
...
desc_not_found='A description has not been found for the language "%s"!'
...
final_lst_empty='final_lst list is still empty. Not enough data?'
...
fragmentary='Fragment "%s" from the given range [%d:%d] is not a separate word, therefore, nothing is being returned.'
...
htm_to_html='Renaming *.htm to *.html...'
...
must_be_greater2='Number %d must be greater than %d, but actually is equal to the latter.'
must_be_greater='A logic error. Number %d must be greater than %d, but actually is less than the latter.'
...
no_amended_table='The file of the amended claims has been found, however, the table of the amended claims is missing!'
no_autotransl_files='Some files required for autotranslation are missing!'
no_changes='Nothing has changed!'
no_claims_found='Neither original, nor amended claims have been found!'
...
no_claims_table='Neither a table of original claims, nor a table of amended claims has been found!'
...
no_en_claims='Neither original, nor amended claims in English have been found!'
...
no_orig_table='The file of the original claims has been found, however, the table of the original claims is missing!'
no_prev_commands='No previous commands!'
no_ru_claims='Neither original, nor amended claims in Russian have been found!'
...
offline_search='Searching %d expressions offline...'
ok='[OK]: "%s"'
...
orig_claims_mode_failure='The original claims mode was set, however, they have not been found.'
orig_claims='Original claims: "%s"'
...
out_of_range='A logic error. Number %d departs from the scope of the range [%d-%d]'
output_pars='Types of output parameters:'
override_mode='Override mode: "%s"'
parent_function='Parent function:'
patent_applicant="Patent: %s\nApplicant: %s"
patent_no='Enter Patent No.:'
pattern_found='"%s" found in "%s"'
pattern='Pattern: "%s"'
pdf_recognize='Do not forget to recognize the inquiry in PDF!'
pdf_txt_missing='PDF and TXT files are missing.'
pdf_txt='PDF and TXT files from the last inquiry are present.'
phrase='Phrase: "%s"'
...
reg_ex_failure3='The regular expression in line "%" has failed!'
...
required_files_missing='The required files are probably missing.\n\nAnalysis results:\nThe last PDF inquiry date: %s\nThe last TXT inquiry date: %s'
...
searching_feature_online='Scanning the online dictionary for the feature "%s".'
searching_phrases_online='Searching %d expressions online...'
searching='Searching...'
search='Search'
...
set_background_failure='Unable to change background for tag "%s"!'
shift_screen_failure2='Failed to shift screen %d to label "%s"!'
shift_screen_failure='Failed to shift screen to label "%s"!'
sing='Singular'
some_claims_not_found='Found claims file "%s", however, claims file "%s" is missing!'
...
tag_config_failure='Failed to configure tag "%s" to have the background of color "%s"!'
tag_configured='Tag %s has been configured to have the background of color %s.'
...
unknown_type="An unknown type '%s'! The following types are supported: 'dics', 'terms', 'comments'."
